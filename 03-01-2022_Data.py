...
# %% save the data _______________________________________________________________________________

Data.tofile("H2CO_filter_phasecorr_{Nifgs}x{PPIFG}.bin".format(Nifgs=9996 - 1, PPIFG=399456 // 2))
