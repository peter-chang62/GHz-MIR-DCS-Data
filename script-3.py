...
path_corrected = r"D:\DATA_MATT_PATRICK_TRIP_2\06-30-2022\Battalion_8\PHASE_CORRECTED_BATT_8_AND_9/"
...
np.save(path_corrected + "co_averaged_batt_8_and_9.npy", co)
np.save(path_corrected + "h2co_averaged_batt_8_and_9.npy", h2co)
